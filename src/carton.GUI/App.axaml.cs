    ...
    public object? Convert(object? value, Type targetType, object? parameter, System.Globalization.CultureInfo culture)
    {
        if (value is NavigationPage page)
        {
            return page switch
            {
                ...
                NavigationPage.Profiles => "M3 7.5A1.5 1.5 0 014.5 6h4.379a1.5 1.5 0 011.06.44l1.682 1.682a1.5 1.5 0 001.06.44H19.5A1.5 1.5 0 0121 10.06v7.44A1.5 1.5 0 0119.5 19h-15A1.5 1.5 0 013 17.5V7.5z M3 10.5h18",
